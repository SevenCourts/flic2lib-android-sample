...
public class Flic2SampleService extends Service {
    ...
    private final static String NOTIFICATION_CHANNEL_ID = "Notification_Channel_Flic2SampleService";
    ...
    public static void createAndStart(Context context) {
        ContextCompat.startForegroundService(context.getApplicationContext(),
                new Intent(context, Flic2SampleService.class).setAction(START_ACTION));
    }
    ...
    public static class BootUpReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // #getAction should be called to get the action of the intent, otherwise warning
